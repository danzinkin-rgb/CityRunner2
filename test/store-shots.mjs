...
const DEFAULT_SET = [
  ...
  { id: 'run-sf', kind: 'run', city: 'sf', level: 2,
    label: 'San Francisco — Market Street (run)',
    why: 'The newest city (1.1): cable cars and trolley wires, a different light again.' },
  { id: 'puzzle-sf-ggbridge', kind: 'puzzle', city: 'sf', level: 1,
    label: 'San Francisco — Golden Gate Bridge (finished monument)',
    why: 'The landmark of the new city, and a bridge silhouette beside the towers.' },
  ...
  { id: 'menu', kind: 'ui', screen: 'menu',
    ...
    why: 'Sells the breadth of the game (five cities) rather than one specific run.' },
